 ...
 */
final class Version20220925221203 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE personaje (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(25) NOT NULL, ataque INT NOT NULL, defensa INT NOT NULL, vida INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
